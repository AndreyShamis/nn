...
class MyNet(object):
    ...
    def get_network_score(self, from_memory=False):
        ...
        logging.info("Accuracy on TEST 1/2 data is: {}% / {}%. [ Final score {}% ]. ".format(__score1, __score2, total_score))
    ...
    def load_network(self, file_path_json, file_path_h5):
        ...
        logging.info("Loading network \n{}\n{}".format(file_path_json, file_path_h5))
